...
public class GameModel {
    ...
    public void initialize(Graphics2D graphics, int levelId) {
        // create textures. Established here to allow for textures to change throughout gameplay
        var texSquare = new Texture("resources/images/wall/wall-1.png");
        var wallTexture = new Texture("resources/images/wall/wall-1.png");
        var rockTexture = new Texture("resources/images/rock/rock-1.png");
        var flagTexture = new Texture("resources/images/flag/flag-1.png");
        var babaTexture = new Texture("resources/images/baba/baba-1.png");
        var floorTexture = new Texture("resources/images/floor/floor-1.png");
        var grassTexture = new Texture("resources/images/grass/grass-1.png");
        var waterTexture = new Texture("resources/images/water/water-1.png");
        var lavaTexture = new Texture("resources/images/lava/lava-1.png");
        var hedgeTexture = new Texture("resources/images/hedge/hedge-1.png");

        var wallTextTexture = new Texture("resources/images/word-wall/word-wall-1.png");
        var rockTextTexture = new Texture("resources/images/word-rock/word-rock-1.png");
        var flagTextTexture = new Texture("resources/images/word-flag/word-flag-1.png");
        var babaTextTexture = new Texture("resources/images/word-baba/word-baba-1.png");
        var isTextTexture = new Texture("resources/images/word-is/word-is-1.png");
        var stopTextTexture = new Texture("resources/images/word-stop/word-stop-1.png");
        var pushTextTexture = new Texture("resources/images/word-push/word-push-1.png");
        var lavaTextTexture = new Texture("resources/images/word-lava/word-lava-1.png");
        var waterTextTexture = new Texture("resources/images/word-water/word-water-1.png");
        var youTextTexture = new Texture("resources/images/word-you/word-you-1.png");
        var winTextTexture = new Texture("resources/images/word-win/word-win-1.png");
        var sinkTextTexture = new Texture("resources/images/word-sink/word-sink-1.png");
        var killTextTexture = new Texture("resources/images/word-kill/word-kill-1.png");
...
//            removeThese.add(entity);
        ...
        sysRuleManager = new RuleManager(level.width, level.height);
